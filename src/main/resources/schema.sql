...
CREATE TABLE IF NOT EXISTS PUBLIC.genre (
	ID INTEGER NOT NULL AUTO_INCREMENT,
	NAME CHARACTER VARYING(50) NOT NULL,
	CONSTRAINT GENRY_PK PRIMARY KEY (ID)
);

CREATE TABLE IF NOT EXISTS PUBLIC.USER_LIKES (
	ID_USER INTEGER,
	ID_FILM INTEGER,
	CONSTRAINT USER_LIKES_PK_1 PRIMARY KEY (ID_USER,ID_FILM)
);

CREATE TABLE IF NOT EXISTS PUBLIC.FILM_GENRES (
	ID_GENRE INTEGER NOT NULL,
	ID_FILM INTEGER NOT NULL,
	CONSTRAINT FILM_GENRES_PK PRIMARY KEY (ID_GENRE,ID_FILM)
);
...
ALTER TABLE PUBLIC.FILMS ADD CONSTRAINT IF NOT EXISTS FILMS_RATING_FK FOREIGN KEY (ID_RATING) REFERENCES PUBLIC.RATING(ID);
